    ...
    <form action="${pageContext.request.contextPath}/login" method="post">
        <table>
            <tr>
                ...
                <td>
                    <input id="input-email" type="email" name="email" class="login__email" required>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input id="input-password" type="password" name="password" class="login__password" required>
                </td>
            </tr>
            <tr>
                <td>
                    <button type="submit" class="login__submit btn btn-success">
                        <fmt:message key="login_log-in" bundle="${texts}"/>
                    </button>
                </td>
            </tr>
        </table>
