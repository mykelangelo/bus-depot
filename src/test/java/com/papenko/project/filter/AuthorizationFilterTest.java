...
class AuthorizationFilterTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {LOGIN_PAGE_URI, ADMIN_PAGE_URI, ASSIGN_DRIVER_TO_BUS_FORM_URI, VACATE_DRIVER_FORM_URI, ASSIGN_BUS_TO_ROUTE_FORM_URI, ADD_ROUTE_URI, DELETE_ROUTE_URI, ADD_BUS_URI})
    ...
    @ParameterizedTest
    @ValueSource(strings = {ADMIN_PAGE_URI, ASSIGN_DRIVER_TO_BUS_FORM_URI, VACATE_DRIVER_FORM_URI, ASSIGN_BUS_TO_ROUTE_FORM_URI, ADD_ROUTE_URI, DELETE_ROUTE_URI, ADD_BUS_URI})
    ...
    @ParameterizedTest
    @ValueSource(strings = {DRIVER_PAGE_URI, ADMIN_PAGE_URI, ASSIGN_DRIVER_TO_BUS_FORM_URI, VACATE_DRIVER_FORM_URI, ASSIGN_BUS_TO_ROUTE_FORM_URI, ADD_ROUTE_URI, DELETE_ROUTE_URI, ADD_BUS_URI})
