...
public class AuthorizationE2ETest implements ScreenShotGeneratingE2ETest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {DRIVER_PAGE_URL, ADMIN_PAGE_URL, ASSIGN_DRIVER_TO_BUS_FORM_URL, VACATE_DRIVER_FORM_URL, ASSIGN_BUS_TO_ROUTE_FORM_URL, ADD_ROUTE_URL})
    ...
    @ParameterizedTest
    @ValueSource(strings = {ADMIN_PAGE_URL, ASSIGN_DRIVER_TO_BUS_FORM_URL, VACATE_DRIVER_FORM_URL, ASSIGN_BUS_TO_ROUTE_FORM_URL, ADD_ROUTE_URL})
